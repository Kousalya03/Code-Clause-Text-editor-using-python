...
def about():
    showinfo("About KText","This is a text editor built using Tkinter\nDeveloped by Kousalya\nGithub:https://github.com/Kousalya03/Text-editor-in-python")
def exitapplication():
    root.quit()
def selectall():
    global textarea
